...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-23 13:46`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f838e9c4-9aa0-4b79-b6ec-ca8636c97aea.git
$ cd f838e9c4-9aa0-4b79-b6ec-ca8636c97aea
```
